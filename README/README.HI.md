...
<details><summary>🌐 भाषा</summary>
<p>

[README](https://github.com/activist-org/activist/tree/main/README) डायरेक्टरी में एक नया रीडमे जोड़ने के लिए [स्थानीयकरण समस्या खोलें](https://github.com/activist-org/activist/issues/new?assignees=&labels=localization&template=localization.yml)
